...
class LongSpeicher20 extends AbstractLongSpeicher {
	...
	// lbi zeigt jetzt immer auf die gr√∂√üte zahl, die im array ist
	...
	LongSpeicher20 lsa = new LongSpeicher20(6);
	lsa.print("lsa");
	printf("-----------------------------------%n");
	printf("True-Tests mit fuegeEin:%n%n");
	...
	lsa.print("lsa");
	printf("lsa.fuegeEin(-30): %b%n", lsa.fuegeEin(-30));
	lsa.print("lsa");

	pln();
	printf("False-Tests f¸r fuegeEin:%n");
	printf("-----------------------------------%n");
	...
	pln();
	printf("True-Tests f¸r istDrin:%n");
	printf("-----------------------------------%n");
	...
	pln();
	printf("False-Tests f¸r istDrin:%n");
	printf("-----------------------------------%n");

	printf("lsa.istDrin(1): %b%n", lsa.istDrin(1));
	lsa.print("lsa");
